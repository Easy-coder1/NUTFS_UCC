    ...
    <header className="w-full bg-slate-900 text-white border-b-2 border-amber-500 shadow-md sticky top-0 z-40">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-md bg-white/10 border border-white/20 flex items-center justify-center text-amber-400 font-bold text-xs tracking-wider shadow-xs">
            UCC
          </div>
          <div>
            ...
            <span className="text-[11px] text-slate-300 block font-sans tracking-wide">
              University of Cape Coast Chapter • Official Portal
            </span>
          </div>
        </div>
